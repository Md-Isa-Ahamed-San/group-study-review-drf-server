...
WSGI_APPLICATION = 'group-study-review-drf-server.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_HOST', 'localhost'), # This should match the service name in docker-compose.yml
